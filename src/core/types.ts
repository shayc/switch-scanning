...
export type ScannerEventBody =
  ...
  | { type: "scan.completed"; reason: "passes" | "empty" }
  | {
      type: "scan.stopped";
      reason: "command" | "disabled" | "after-activation";
    }
...
type HighlightChangedEventBody =
  | {
...
export type StartOn = "input" | "mount" | "manual";
...
export interface ScannerInputPort {
   ...
   * additionally invalidates an armed single-switch dwell per the method's
